...
@IonicPage()
@Component({
  selector: 'page-custcouponbuy',
  templateUrl: 'custcouponbuy.html',
})
export class CustcouponbuyPage {
package:any;
order_num:any;
price:any;
payment:any;
...
promo_code:any;
  ...
  goRaserpay(promo_code,paymode_id,price,ordernumber,total_credit,cost_gst,phone,name)
  {
         ...
         let me = this;
          var successCallback = function(payment_id) {
          	me.storage.get('userid').then((userid) => {
		  		me.api.post('credit_resorpaycoupon',{promo_code:promo_code,userid:userid,ordernumber:ordernumber,package:me.package,price:price,paymode_id:paymode_id,total_credit:total_credit,cost_gst:cost_gst}).subscribe((res:any) => {
              me.navCtrl.setRoot('JobPage');
		  		});
	  		});
          };
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CustcouponbuyPage');
  }

...
@IonicPage()
@Component({
  selector: 'page-addsubcat',
  templateUrl: 'addsubcat.html',
})
   ...
   // this.storage.get('userid').then(userid=>{
      ...
      this.api.post('getcompanydtl',{userid:this.user_id}).subscribe((res:any) => {
       ...
       // this.storage.get('userid').then(userid=>{
          ...
          //-------------------------------------------
          this.api.post('addsubcat1',{userid:this.user_id,scid:this.scid,cat_id:this.cat_id,companyid:this.companyid}).subscribe((res:any) => {
...
//alert('hahaha='+data.response);
 ...
 //alert('newstr='+newstr);
  ...
  savesubcat()
  {
        ...
        companyid:this.companyid}).subscribe((res:any) => {            
          loading.dismiss();
                          ...
                          this.navCtrl.push('ListMasterPage',{userid:this.user_id, flowcountno:this.flowcountno,catid: this.cat_id,companyid:this.companyid,subcat_level:'2' });
                          /*
                              //this.storage.get('userid').then((userid) => {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AddsubcatPage');
  }

...
@IonicPage()
@Component({
  selector: 'page-serviceandrepair1',
  templateUrl: 'serviceandrepair1.html',
})
export class Serviceandrepair1Page {
 qty:any;
scid: any; 
subradios: any;
epoint: any;
			...
			if(this.subradios!=undefined)
			 {
				...
				this.api.get('getSubcatinfo',{scid:this.subradios,catid:this.catid,company_id:this.company_id}).subscribe((res1:any) => {
...
//this.general.hideLoading(); 
	...
	//alert('repair1='+this.subradios+'--'+this.catid+'--'+this.subcat_level);
							  ...
							  this.navCtrl.push('Serviceandrepair2Page',{scatid : this.subradios,catid:this.catid,subcat_level:this.subcat_level,userid:this.userid,company_id:this.company_id,flowcountno:this.flowcountno});
							 // loading.dismiss();
							} 
							else
							 {
							   this.navCtrl.push('Serviceandrepair1Page',{ scatid : this.subradios,catid:this.catid,userid:this.userid,company_id:this.company_id,subcat_level:this.subcat_level,flowcountno:this.flowcountno});
							 // loading.dismiss();
							 }             
					   }
					   else
